...
$field_configs = [
  ...
  'field_channels' => ['weight' => 11, 'type' => 'entity_reference_autocomplete', 'region' => 'sidebar'],
  'field_topics' => ['weight' => 12, 'type' => 'entity_reference_autocomplete_tags', 'region' => 'sidebar'],
  'field_cancer_types' => ['weight' => 13, 'type' => 'entity_reference_autocomplete_tags', 'region' => 'sidebar'],
  'field_content_type' => ['weight' => 14, 'type' => 'options_select', 'region' => 'sidebar'],
  'field_homepage_placement' => ['weight' => 15, 'type' => 'options_select', 'region' => 'sidebar'],
...
$groups = [
  ...
  'group_metadata' => [
    'label' => 'Metadata',
    'children' => ['field_issue', 'field_channels', 'field_topics', 'field_cancer_types', 'field_content_type', 'field_homepage_placement'],
    'weight' => 1,
    'format_type' => 'tab',
    'format_settings' => [
      'direction' => 'vertical',
